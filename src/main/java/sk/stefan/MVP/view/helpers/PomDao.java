...
public class PomDao {
	...
	public static String getGettersForResultSet(String typ) {
		StringBuilder sb = new StringBuilder();
		sb.append("get");
		if ("java.lang.Integer".equals(typ)){
			sb.append("Int");
		} else if ("java.util.Date".equals(typ)){
			sb.append("Timestamp");
		} else {
	...
	/**
	 * Metoda sluzi k prevodu java.util.Date do stringu,
	 * ktory je ochotny spolknout typ MYSQL timestamp.
	 */
