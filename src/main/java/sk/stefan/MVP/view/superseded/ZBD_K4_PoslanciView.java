...
import sk.stefan.MVP.view.components.ZBD_AddVoteOfRoleComponent;
 ...
 * @author veres
 */
public class ZBD_K4_PoslanciView extends VerticalLayout implements View {
   ...
   private ZBD_AddVoteOfRoleComponent avorc;
     ...
     *
     */
    public ZBD_K4_PoslanciView(Navigator nav) {
