 ...
 * @author veres
 */
public class ZBD_K5_Verejna_osobaView extends HorizontalSplitPanel implements View,
        ZBD_GeneralComponentListener {
     ...
     *
     */
    public ZBD_K5_Verejna_osobaView() {
        ...
        this.initLayout();
        // this.initLayMenuBar();
        poslanecFL.addComponent(NavigationComponent.createNavigationComponent());
        ...
        removeVoteOfRoleBT.addClickListener(new ClickListener() {
            ...
            public void buttonClick(ClickEvent event) {
                final ZBD_YesNoWindow window = new ZBD_YesNoWindow("Upozornenie",
                        ...
                        (ZBD_GeneralComponentListener) event.getButton()
