...
public class ZBD_Kos1View extends VerticalLayout implements View {

    /**
     *
     */
    private static final long serialVersionUID = -4477685954704536404L;

    VerticalLayout layout;
    MenuBar menubar;
    Navigator navigator;

    public ZBD_Kos1View(Navigator nav) {
    ...
    private void initLayout() {
        ...
        /*
         * InlineDateField date1 = new InlineDateField("MY DATE 1");
         * date1.setValue(new Date()); date1.setDateFormat("yyyy-MM-dd");
         * date1.setLenient(true);
         * 
