 ...
 * @author veres
 */
public class K5_PoslanciView extends VerticalLayout implements View {

	public EntityProvider<Planet> vitemprov;
	public EntityContainer<Planet> vitemcontainer;
	 ...
	 * 
	 */
	public K5_PoslanciView(Navigator nav) {
		
		this.navigator = nav;
		pupRepo = new UniRepo<PublicPerson2>(PublicPerson2.class);
		poslRepo = new UniRepo<PublicPerson>(PublicPerson.class);
