 ...
 * @author veres
 */
public class K4_Verejna_osobaView extends HorizontalSplitPanel implements View,
	 ...
	 * 
	 * */
	public K4_Verejna_osobaView(Navigator nav) {
		...
		this.initLayout();
		// this.initLayMenuBar();
		poslanecFL.addComponent(new NavigationComponent(nav));
		try {
			this.initPoslanecFL();
