...
import sk.stefan.MVP.view.components.layouts.VoteOfRolesBrief2Layout;
...
public class VOT_detPanContent extends GridLayout {
    ...
    private VoteOfRolesBrief2Layout voteOfRolesBriefLy;
    ...
    private void initLayout() {
        ...
        this.voteOfRolesBriefLy = new VoteOfRolesBrief2Layout(voteOfRoles,voteService);
