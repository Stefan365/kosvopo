 ...
 * @author stefan
 */
public class PubPersonsBriefLayout extends VerticalLayout implements Filterable {
    ...
    //0.konstruktor
    public PubPersonsBriefLayout(List<PublicPerson> pubPersons, PublicPersonService pps){
