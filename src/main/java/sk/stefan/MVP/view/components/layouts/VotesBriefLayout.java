...
import sk.stefan.MVP.view.components.panContents.VOT_briefPanContent;
 ...
 * @author stefan
 */
public class VotesBriefLayout extends VerticalLayout implements Filterable {
    ...
    //0.konstruktor
    public VotesBriefLayout(List<Vote> votes, VoteService vots){
