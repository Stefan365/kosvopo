...
import sk.stefan.MVP.view.components.panContents.VOR_briefPanContent;
 ...
 * @author stefan
 */
public class VoteOfRolesBriefLayout extends VerticalLayout implements Filterable {
     ...
     * @param vots
     */
    public VoteOfRolesBriefLayout(List<VoteOfRole> votesOfRole, VoteService vots){
