...
public class UniTable extends HorizontalSplitPanel {
	...
	//0. Konstruktor
	public UniTable(String tableName) {
		super();
	...
	private void initEditor() {
		...
		butEdit.addListener(new ClickListener(){
			@Override
		...
		butSave.addListener(new ClickListener(){
			@Override
			public void buttonClick(ClickEvent event) {
	...
	private void initcontactListTable() {
		...
		contactListTable.setVisibleColumns(new Object[] {visibleFieldNames});
...
/*
	...
	*/	
		...
		contactListTable.addListener(new Property.ValueChangeListener() {
			public void valueChange(ValueChangeEvent event) {
				Object contactId = contactListTable.getValue();
